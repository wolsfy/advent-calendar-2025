const tasks = {
    ...
    11: {
        title: "Задание на 11 декабря: 😋 Вкусно и точка",
        task: "Сфотографируй свою любимую еду, которую ты покупаешь только перед Новым годом или Рождеством.",
    },
    12: {
    ...
    23: {
        ...
        task: "Назови самый странный (или самый полезный) предмет, который ты купила в этом году.",
    },
    24: {
    ...
    25: {
        title: "Задание на 25 декабря: 😴 Экстра-Чилл",
